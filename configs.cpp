...
float Ki = 0.0;
float Kd = 0.0;
float defaultKp = 8.0;  // Increased for faster response to errors
float defaultKi = 2.0;  // Increased for gravitational compensation
float defaultKd = 1.5;  // Increased for oscillation damping
